...
export default function VideoComponent() {
  ...
  // Faster scaling effect (completes early)
  const parallax = useParallax({
    scale: [0.5, 1],
    easing: "easeOutCubic",
    shouldAlwaysCompleteAnimation: true,
    rootMargin: { top: -100, bottom: -100 }, // <-- makes effect finish sooner
  });
  ...
  return (
    <>
      <div
        id="how_it_works"
        ref={parallax.ref}
        className="how-it-works section panel scrollSpysection p-2 w-full"
      >
        <div
