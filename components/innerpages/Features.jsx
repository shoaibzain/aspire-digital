        ...
        <div className="container max-w-xl lg:max-w-lg">
          ...
          >
            ...
            <div className="panel vstack gap-4 xl:gap-6">
              <div className="panel px-3 rounded-2 bg-black dark:bg-gray-800">
                <ul
                ...
                >
                  <li
                    ...
                    role="presentation"
                  >
                    <a className="h6 lg:h5 text-nowrap m-0 text-white">Audit Trial</a>
                  </li>
                  <li
                    ...
                    role="presentation"
                  >
                    <a className="h6 lg:h5 text-nowrap m-0 text-white">Tool Workflow</a>
                  </li>
                  <li
                    ...
                    role="presentation"
                  >
                    <a className="h6 lg:h5 text-nowrap m-0 text-white">
                      Control your Apps
                    </a>
                  </li>
                  <li
                    ...
                    role="presentation"
                  >
                    <a className="h6 lg:h5 text-nowrap m-0 text-white">Approvals</a>
                  </li>
                </ul>
              </div>
              <div
